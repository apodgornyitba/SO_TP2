    ...
    while ((ch = *fmt++))
    {
        if ('%' == ch)
        {
            ...
            case 'c':
                ...
                sysWrite(2, (uint64_t)char_temp, 1, 0, 0);
                length++;
                break;
            ...
            case 's':
                ...
                length = strlength(string_temp);
                sysWrite(2, (uint64_t)string_temp, length, 0, 0);
                length += strlength(string_temp);
                break;
            ...
            case 'd':
                ...
                sysWrite(2, (uint64_t)buffer, length, 0, 0);
                length += strlength(buffer);
                break;
